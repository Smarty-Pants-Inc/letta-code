  ...
  function LoadingApp({
    ...
    if (!agentId || !conversationId) {
      return React.createElement(App, {
        ...
        tokenStreamingGlowHotColor: settings.tokenStreamingGlowHotColor,
        tokenStreamingGlowWarmColor: settings.tokenStreamingGlowWarmColor,
        tokenStreamingGlowCoolColor: settings.tokenStreamingGlowCoolColor,
